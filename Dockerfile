...
RUN echo "Flutter sdk" && \
    cd /opt && \
    wget --quiet https://storage.googleapis.com/flutter_infra/releases/stable/linux/flutter_linux_1.22.6-stable.tar.xz -O flutter.tar.xz && \
...
LABEL maintainer="Teoh Kheng Hong"
LABEL org.label-schema.schema-version="1.0"
LABEL org.label-schema.name="tkhenghong/flutter_fastlane_jenkins"
LABEL org.label-schema.version="${DOCKER_TAG}"
LABEL org.label-schema.usage="/README.md"
LABEL org.label-schema.docker.cmd="docker run -d -p 8080:8080 tkhenghong/flutter_fastlane_jenkins"
